...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center pt-2 px-3">
      {/* Compact Heads-Up Notification Style - No phone number */}
      <div className="w-full max-w-[280px] bg-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 overflow-hidden">
        {/* Header Row: PRONTO + Close */}
        <div className="flex items-center justify-between p-3 pb-2">
          <div className="flex items-center gap-2">
            <span className="text-lg">📞</span>
            <span className="text-teal-400 font-bold text-sm tracking-wide">PRONTO</span>
          </div>
          <button
            onClick={() => action('CLOSE')}
            className="w-7 h-7 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-all active:scale-90"
            title="Chiudi"
          >
        ...
        {/* Action Buttons: Rispondi | Rifiuta */}
        <div className="px-3 pb-2 flex gap-2">
          <button
            onClick={() => action('ANSWER')}
            className="flex-1 py-2.5 bg-blue-500 hover:bg-blue-600 rounded-xl text-white font-semibold text-sm transition-all active:scale-95 flex items-center justify-center gap-1.5"
          >
          ...
          <button
            ...
            className="flex-1 py-2.5 bg-red-500 hover:bg-red-600 rounded-xl text-white font-semibold text-sm transition-all active:scale-95 flex items-center justify-center gap-1.5"
            title="Nota: Su Android 10+ potrebbe non funzionare - usa i pulsanti di sistema"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="px-3 pb-3">
          <button
            ...
            className="w-full py-2.5 bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#20bd5a] hover:to-[#0f7a6b] rounded-xl flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-lg"
          >
            ...
            <span className="text-white font-semibold text-sm">Apri WhatsApp</span>
          </button>
        </div>
      </div>
    </div>
