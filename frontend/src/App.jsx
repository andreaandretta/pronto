      ...
      <div className="w-full max-w-[280px] bg-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 overflow-hidden">
        ...
        <div className="px-3 pb-3">
          <button
            ...
            className="w-full py-3 bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#20bd5a] hover:to-[#0f7a6b] rounded-xl flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-lg"
          >
