...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center pt-2 px-3">
      {/* Compact Heads-Up Notification Style */}
      <div className="w-full max-w-[320px] bg-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 overflow-hidden">
        ...
        <div className="flex items-center gap-3 p-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-white/60 text-xs">Chiamata in arrivo</p>
            <p className="text-white font-semibold text-sm truncate">{phoneNumber}</p>
          </div>
          
          {/* WhatsApp Button */}
          <button
            onClick={() => action('WHATSAPP')}
            className="w-10 h-10 bg-[#25D366] hover:bg-[#20bd5a] rounded-full flex items-center justify-center flex-shrink-0 transition-all active:scale-90 shadow-lg"
            title="Apri WhatsApp"
          >
          ...
          <button
            ...
            className="w-8 h-8 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center flex-shrink-0 transition-all active:scale-90"
            title="Chiudi"
          >
        ...
        {/* Subtle PRONTO branding */}
        <div className="px-3 pb-2">
          <p className="text-white/30 text-[10px] text-center">PRONTO • tap WhatsApp per chattare</p>
        </div>
      </div>
    </div>
  )
